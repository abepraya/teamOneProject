<?php 
	...
	//Membuat SQL Query
	$sql = "SELECT t.id_ticket, e.name_emp name_submitter, t.create_date, t.assign_date, t.end_date, p.problem_name, t.problem_detail, es.name_emp name_solver, t.dev_note
			FROM ticket t
