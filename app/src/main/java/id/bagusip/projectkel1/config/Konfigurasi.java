...
public class Konfigurasi
{
    ...
    //DEVELOPER
    //GET TICKET ON GOING
    public static final String URL_GET_ALL_ON_GOING_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/ongoing_ticket.php?id_solver=";
    public static final String URL_GET_DETAIL_ON_GOING_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/ongoing_ticket_detail.php";
    public static final String URL_UPDATE_ON_GOING_TICKET_DETAIL_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/update_ongoing_ticket.php";

    //GET TICKET QUEUE
    public static final String URL_GET_ALL_QUEUE_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/queue_ticket.php?id_division=";
    public static final String URL_GET_DETAIL_QUEUE_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/queue_ticket_detail.php";
    public static final String URL_UPDATE_QUEUE_TICKET_DETAIL_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/update_queue_ticket.php";

    //GET HISTORY TICKET
    public static final String URL_GET_ALL_HISTORY_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/history_ticket.php?id_solver=";
    public static final String URL_GET_DETAIL_HISTORY_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/history_ticket_detail.php";

    //GET TICKET SOLVED
    public static final String URL_GET_ALL_SOLVED_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/solve_ticket.php?id_solver=";
    public static final String URL_GET_DETAIL_SOLVED_TICKET_DEVELOPER = "http://192.168.1.3/teamOneProject/dashboard_dev_test/solve_ticket_detail.php";
